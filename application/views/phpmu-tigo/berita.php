			...
			<div class="content-block main left">
				<div class="block">
					...
					<div class="block-content">
						<?php foreach ($berita->result_array() as $r) {
							  // 	$baca = $r['dibaca']+1;
							  ...
							  // 	echo "<div class='article-big'>
									...
									echo "<div class='article-big'>
										<div style='height:120px; background:#e3e3e3; overflow:hidden' class='article-photo'>
											<a href='".base_url()."produk/detail/$r[produk_seo]' class='hover-effect'>";
												if ($r['gambar'] == ''){
													echo "<img style='width:210px;' src='".base_url()."asset/foto_produk/no-image.jpg' alt='no-image.jpg' /></a>";
												}else{
													echo "<img style='width:210px;' src='".base_url()."asset/foto_produk/$r[gambar]' alt='$r[gambar]' /></a>";
												}
											echo "</a>
										</div>
										<div class='article-content'>
											<h2><a title='$r[nama_produk]' href='".base_url()."produk/detail/$r[produk_seo]'>$r[nama_produk]</a><br/><a href='".base_url()."produk/detail/$r[produk_seo]'>Rp. ".rupiah($r["harga_konsumen"])."</a></h2>
											".$r["keterangan"]."
										</div>
									</div>";
						  	  } ?>
