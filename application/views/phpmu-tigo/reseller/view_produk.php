...
<?php 
  ...
  foreach ($record->result_array() as $row){
    ...
    $jumlah = $this->model_app->view_where("rb_produk",array("id_produk"=>$row['id_produk']))->row()->jumlah;
    if ($jumlah <= 0){ $stok = '<span class="harga" style="color:000">Stok Habis</span>'; }else{ $stok = "<span class='harga' style='color:green'>Stok ".$jumlah." $row[satuan]</span>"; }
    ...
    if ($diskon > 0){ 
        $diskon_persen = "<div class='box ofh'><div class='top-cross-ribbon'>$diskon</div></div>";
    ...
    echo "<div class='produk col-md-2 col-xs-6' style='box-shadow: 5px 5px 5px lightgrey;
            ...
            <center>
              ...
              <h4 class='produk-title' style='color: black;'>$judul</h4>
