<?php echo "<p class='sidebar-title'> Data Pelanggan</p>
            <div class='alert alert-info'><b>PENTING!</b> - Lengkapi Form dibawah ini untuk menyelesaikan pesanan anda, Terima kasih...</div><br>
                <div class='col-md-12'>";
