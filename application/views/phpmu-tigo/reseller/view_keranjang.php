...
<table class='table table-condensed'>
  <tbody>
    <?php if (trim($rows['foto'])==''){ $foto_user = 'users1.gif'; }else{ $foto_user = $rows['foto']; } ?>
    ...
    <tr><th scope='row'>Alamat</th> <td><?php echo $rows['alamat_lengkap']!=""?$rows['alamat_lengkap']:"-"; ?></td></tr>
    <!-- <tr><th scope='row'>Alamat Email</th> <td><?php echo $rows['email']!=""?$rows['email']:"-"; ?></td></tr> -->
