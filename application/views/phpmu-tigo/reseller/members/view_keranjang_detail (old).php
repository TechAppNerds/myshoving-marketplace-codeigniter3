<div class='alert alert-success' style='margin:10px 0px;'><center>Success Melakukan Konfirmasi pembayaran... <br>
  ...
  <hr>
      ...
      <table class="table table-striped table-condensed">
        ...
        <?php 
          ...
          if ($rows['proses']=='0'){ $proses = '<i class="text-danger">Pending</i>'; $status = 'Proses'; }
          elseif($rows['proses']=='1'){ $proses = '<i class="text-success">Proses</i>'; }
          else{ $proses = '<a href="'.base_url().'"><button class="btn btn-info">Kembali</button></a>'; }
          echo "
                <tr class='success'>
                ...
                <tr class=''><td align=center colspan='6'><b>$proses</b></td></tr>
        </tbody>
      </table>";