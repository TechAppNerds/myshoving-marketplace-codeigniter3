<div class='col-md-12'>
	...
	<div class='box box-info'>
		<div class='box-header with-border'>
			<center><h3 class='box-title'>MUTASI REKENING PERUSAHAAN (ALOKASI Rp.3.000 / MEMBER YG JOIN)</h3></center>
			<div class='box-body'>
				<?php
					echo "Berikut adalah data mutasi rekening perusahaan (alokasi Rp.3.000 / member yg join) :</b><br><br>";
					...
					$no = 1;					
					$cari = $this->db->query("SELECT * FROM `mutasi_perusahaan` order by saldo desc");
                    if ($cari->num_rows()<=0)
					{
