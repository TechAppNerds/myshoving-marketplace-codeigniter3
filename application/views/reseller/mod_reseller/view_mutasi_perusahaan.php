<div class='col-md-12'>
	...
	<div class='box box-info'>
		<div class='box-header with-border'>
			<center><h3 class='box-title'>MUTASI REKENING PERUSAHAAN</h3></center>
			<div class='box-body'>
				<?php
					echo "Berikut adalah data mutasi rekening perusahaan :</b><br><br>";
					...
					$no = 1;					
					$cari = $this->db->query("SELECT * FROM `mutasi_rek` where id_reseller=".$this->session->id_reseller." order by saldo desc");
                    if ($cari->num_rows()<=0)
					{
