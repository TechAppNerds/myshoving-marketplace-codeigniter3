          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url().$this->uri->segment(1); ?>"><i class='fa fa-circle-o'></i>Akun Pembeli</a></li>
                <li><a href="<?php echo base_url().$this->uri->segment(1); ?>"><i class='fa fa-circle-o'></i>Akun Toko</a></li>
              </ul>
            </li>
             <li class="treeview">
