                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <?php 
                        ...
                        echo "<tr>
                                ...
                                <td><input class='form-control' type='number' name='bb' value='$row[harga_jual]' id='harga' min='1'> </td>

                                <td><input class='form-control' type='number' name='dd' value='$row[jumlah]' min='1'></td>
