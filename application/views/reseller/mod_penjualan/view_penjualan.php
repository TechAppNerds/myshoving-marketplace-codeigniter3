      ...
      <table id="example1" class="table table-bordered table-striped table-condensed">
        ...
        <?php 
          ...
          echo "<tr><td>$no</td>
                    ...
                    <td><center>
                      <a class='btn btn-success btn-xs' title='Detail Data' href='".base_url()."reseller/detail_penjualan/$row[id_penjualan]'><span class='glyphicon glyphicon-search'></span> Update Status</a>
