<style type="text/css">
  ...
  .sekolah:hover{
    color:#fff;
        ...
        <!-- Logo -->
        <a href="<?php echo base_url('Administrator/index')?>" class="logo">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                <a href="<?php echo base_url('ChatController/detailchat')?>" target="_blank" class="dropdown-toggle" data-toggle="dropdown">
