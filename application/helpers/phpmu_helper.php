<?php 
    ...
    function cek_session_reseller_timeout(){
        $ci = & get_instance();
        ...
        if (is_null($session)) {
          ...
          echo "<script type='text/javascript'>
                  $(document).ready(function(){
                    var closeInSeconds = 5, displayText = 'Redirecting in #1 seconds.', timer;
                    swal({                
                        title: 'Maaf, Waktu Anda Sudah Habis. Silahkan Login Kembali',
                      ...
                      timer = setInterval(function() {
                        ...
                        $('div#swal2-content').text(displayText.replace(/#1/, closeInSeconds));
                      },1000);
                  });
               </script>";
        }
